...
export class XpeditionCell {
	...
	addPin(pin: XpeditionPin): void {
		this.pins.push(pin);
	}
	addAssemblyOutline(o: AssemblyOutline): void {
		this.assemblyOutlines.push(o);
	}
	addSilkscreenOutline(o: SilkscreenOutline): void {
		this.silkscreenOutlines.push(o);
	}
	addSolderMask(m: SolderMask): void {
		this.solderMasks.push(m);
	}
	addSolderPaste(p: SolderPaste): void {
		this.solderPastes.push(p);
	}
	addPlacementOutline(o: PlacementOutline): void {
		this.placementOutlines.push(o);
	}
	getPinCount(): number {
...
export class SymbolPinGroup {
	...
	addAnnotation(a: SymbolAnnotation): void {
...
export class SymbolPart {
	...
	addPinGroup(g: SymbolPinGroup): void {
		this.pinGroups.push(g);
	}
	addShape(s: SymbolShapeBase): void {
		this.shapes.push(s);
	}
