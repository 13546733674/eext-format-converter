...
export interface EeSymbolPinDot {
	dotX: number;
	dotY: number;
}

export interface EeSymbolPinPath {
	path: string;
	color: string;
}
...
export interface EeSymbolPinDotBis {
	isDisplayed: boolean;
	circleX: number;
	circleY: number;
}
export interface EeSymbolPinClock {
	isDisplayed: boolean;
	path: string;
}
...
export type EeSymbolPolygon = EeSymbolPolyline;
...
export interface EeFootprintBbox {
	x: number;
	y: number;
	width: number;
	height: number;
