...
function addSyntheticPadstack(
  padMap: Map<string, XpedPad>,
  holeMap: Map<string, XpedHole>,
  psMap: Map<string, XpedPadstack>,
): void {
...
testCC0805().catch(e => { console.error('Test failed:', e); process.exit(1); });
